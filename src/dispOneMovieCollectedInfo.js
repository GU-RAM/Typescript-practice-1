...
export function displayCollectedInfo(ageOfMovie, actorsNames, currencies, flags) {
    ...
    oneMovieSearchDiv === null || oneMovieSearchDiv === void 0 ? void 0 : oneMovieSearchDiv.prepend(searchedMovieInfo);
